...
const mapDispatchToProps = (dispatch) => {
    return {
        removeScreenshot: (screenshot) => dispatch(actionCreators.removeScreenshot(screenshot))
    };
}

function ScreenshotBadge(props) {
    function handleRemoveScreenshot() {
        props.removeScreenshot(props.fileName);
    }
...
export default connect(null, mapDispatchToProps)(ScreenshotBadge);