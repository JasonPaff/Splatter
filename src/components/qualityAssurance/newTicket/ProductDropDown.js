...
const productOptions = [
    ...
    { product: 'Fake Product Two', description: 'one line description', current: false },
    { product: 'Fake Product Three', description: 'one line description', current: false },];
                            ...
                            <div className="inline-flex shadow-sm rounded-md divide-x divide-indigo-600">
                                <div
                                    ...
                                    <div
                                        ...
                                        <p className="ml-2.5 text-sm font-medium">{selected.product}</p>
                                    </div>
                                    <Listbox.Button
                                            ...
                                            {({selected, active}) => (
                                                <div className="flex flex-col">
                                                    <div className="flex justify-between">
                                                        <p className={selected ? 'font-semibold' : 'font-normal'}>{option.product}</p>
                                                        {selected ? (
