...
const navigation = [
    ...
    { name: 'New Ticket', href: '/qaNewTicket', icon: ClockIcon, current: false },
    { name: 'Open Tickets', href: '/qaOpenTicket', icon: ScaleIcon, current: false },
    { name: 'Closed Tickets', href: '/qaClosedTickets', icon: CreditCardIcon, current: false },
]
const secondaryNavigation = [
    { name: 'Profile', href: '/qaProfile', icon: QuestionMarkCircleIcon },
    { name: 'Settings', href: '/qaSettings', icon: CogIcon },
    { name: 'Help', href: '/qaSupport', icon: ShieldCheckIcon },
]
const cards = [
